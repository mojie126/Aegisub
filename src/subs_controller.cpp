...
, autosave_queue(agi::dispatch::Create())
{
	...
	autosave_opt_connection = OPT_SUB("App/Auto/Save", [this] { autosave_timer_changed(&autosave_timer); });
	autosave_interval_connection = OPT_SUB("App/Auto/Save Every Seconds", [this] { autosave_timer_changed(&autosave_timer); });
