...
, c(c)
{
	...
	auto *source_res_box = source_res_box_sizer->GetStaticBox();
	auto *dest_res_box = dest_res_box_sizer->GetStaticBox();
	auto *margin_box = margin_box_sizer->GetStaticBox();
	...
	source_x = new wxSpinCtrl(source_res_box, -1, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, INT_MAX);
	source_y = new wxSpinCtrl(source_res_box, -1, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, INT_MAX);
	source_matrix = new wxComboBox(source_res_box, -1, "", wxDefaultPosition,
		wxDefaultSize, to_wx(MatrixNames()), wxCB_READONLY);
	dest_x = new wxSpinCtrl(dest_res_box, -1, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, INT_MAX);
	dest_y = new wxSpinCtrl(dest_res_box, -1, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, INT_MAX);
